...
2. 写文件
'''
with open('D:\py_zichen\Variable\FileAndException\测试写文件1.txt', mode = 'a', encoding = 'utf-8') as data2:
    data2.write('又写入了一个lemon\n又写入了一个lemon')
'''
3. 写文件
'''
with open('D:\py_zichen\Variable\FileAndException\测试写文件1.txt', mode = 'a', encoding = 'utf-8') as data3:
    data3.writelines('lemonlemonlemonlemonlemonlemonlemon\nlemonlemonlemone')
'''
4. 写文件，传入序列
'''
with open('D:\py_zichen\Variable\FileAndException\测试写文件1.txt', mode = 'a', encoding = 'utf-8') as data4:
